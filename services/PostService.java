...
public class PostService {
  ...
  String SQL_postsByUser = "SELECT * FROM " + DatabaseInfo.Tables.POSTS + " WHERE USER_ID = \"" +user.getIdString()+ "\" ORDER BY POST_DATE DESC;
  ...
  public static List<Post> mostRecentNews() {
    ...
    recentNews.add(post);
      ...
      System.out.println("There was a problem with retrieving most recent posts from the database.")
    }
    return recentNews;
  }
